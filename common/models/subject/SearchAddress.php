...
/**
 * SearchAddress represents the model behind the search form about `common\models\subject\Address`.
 */
class SearchAddress extends Address
{
    ...
    {
        return [
            [['id', 'address_type_id', 'created_by', 'updated_by', 'state_id'], 'integer'],
            [['street', 'house_nr', 'city', 'postal_code', 'created_at', 'updated_at'], 'safe'],
        ];
    }
