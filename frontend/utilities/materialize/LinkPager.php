 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com> modified by Camus <ja@camus.cz>
 * @since 2.0
 */
class LinkPager extends Widget
{
	...
	/**
	 * @var string the CSS class for the internal page button.
	 */
	public $internalPageCssClass = 'waves-effect';
