...
/**
 * SideNav renders a side-nav HTML component.
 *
 * For example:
 *
 * ```php
 ...
 * @author camus <ja@camus.cz>
 * @since 2.0
 */
class SideNav extends Widget
{
    /**
     * @var array list of items in the side-nav widget. Each array element represents a single
     * menu item which can be either a string or an array with the following structure:
     *
     * - label: string, required, the side-nav item label.
    ...
    public function renderItem($item)
    {
        ...
        if ($items !== null) {
            ...
            if (is_array($items)) {
	            ...
	            Html::addCssClass($linkOptions, 'collapsible-header');
            }
	        $content = Html::tag('ul', Html::tag('li', Html::a($label, $url, $linkOptions) . Html::tag('div', $items, ['class' => 'collapsible-body'])), ['class' => 'collapsible collapsible-accordion']);
        } else {
